...
class AlbertForABSA(AlbertModel):
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None, labels=None):
        pooled_output, albert_emb = self.albert_forward(input_ids, token_type_ids, attention_mask) 
        ...
        if labels is not None:
            ...
            if pooled_output.requires_grad: #if training mode
                perturbed_sentence = self.adv_attack(albert_emb, _loss)
    ...
    def albert_forward(self, input_ids, token_type_ids=None, attention_mask=None):
        ...
        print("Shape of embedding_output: {}".format(embedding_output.shape))
        print("Shape of last encoded layer: {}".format(encoded_layers[-1].shape))
        print("Shape of pooled_output: {}".format(pooled_output.shape))
